...
PSBMMove::PSBMMove(IPMonster* player)
{
	m_Monster = player;
}

void PSBMMove::Init(string name)
{
	isSet = false;
...
void PSBMMove::Update(float deltaTime, HitBox* hitBox)
{
...
void PSBMMove::Render(sf::RenderWindow* window)
{
